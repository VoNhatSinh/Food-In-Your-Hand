package com.company.sinh_tan.common.view;
...
public class SlidingTabLayout extends HorizontalScrollView{
    ...
    public void setCustomTabView(int layoutResId, int imageViewId) {
        ...
        // mTabViewTextViewId = imageViewId;
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTabViewLayoutId != 0) {
                ...
                tabImageView.setImageDrawable(getContext().getResources().getDrawable(getIconResourceArray()[i]));
            }
    ...
    private Fragment getCurrentFragment(){
        ...
        if(fragment != null)
        Toast.makeText(activity.getApplicationContext(), fragment.getTag(), Toast.LENGTH_LONG).show();
       return fragment;
    ...
    private class TabClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
           // Toast.makeText(activity.getApplicationContext(), "tab click", Toast.LENGTH_SHORT).show();
            FragmentManager fragmentManager = activity.getSupportFragmentManager();
            if(activity.getSupportFragmentManager().getBackStackEntryCount() == 2)
            {
              activity.getSupportFragmentManager().popBackStack();
            }
            if(activity.getSupportFragmentManager().getBackStackEntryCount() == 3)
            {
                Toast.makeText(activity.getApplicationContext(), "fargment 3", Toast.LENGTH_SHORT).show();
                //activity.getSupportFragmentManager().beginTransaction().replace(R.id.detail_store_fragment, getCurrentFragment()).addToBackStack(null).commit();
